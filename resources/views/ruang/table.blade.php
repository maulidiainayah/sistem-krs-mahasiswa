...
<body>
    ...
    <div class="action-links" style="text-align: center; margin-bottom: 20px;">
        <button onclick="location.href='{{ url('ruang/create') }}'">Tambah Data Ruang</button><br>
    ...
    <div class="table-container">
     ...
     <tbody> 
            ...
            <tr>
                ...
                <td>
                    <a href="{{ url('ruang/' . $value->id . '/edit') }}">edit</a> |
                    <form action="{{ url('ruang/' . $value->id) }}" method="post" style="display:inline;">
                        @csrf
                        @method('DELETE')
